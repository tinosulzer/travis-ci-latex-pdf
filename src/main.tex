...
% Copy of local file C:/Program Files/SageMath 8.0/runtime/opt/sagemath-8.0/local/share/texmf/tex/latex/sagetex/sagetex.sty
% Not pre se machine-independent, since it needs a specific sage version.
\usepackage{sagetex}
